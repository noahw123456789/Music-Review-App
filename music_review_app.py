...
def all_songs():
    ...
    # Log missing files
    for song in songs:
        thumbnail_path = os.path.join(app.static_folder, 'Images/Song-Covers', song['thumbnail'])
        audio_path = os.path.join(app.static_folder, 'Songs', song['audio'])
        if not os.path.isfile(thumbnail_path):
            print(f"Missing thumbnail: {thumbnail_path}")
